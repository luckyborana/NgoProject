        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-8 col-sm-12 content-area sidebar_right">
                    ...
                    <div class="inner">
                        <article>
                            <h1 class="entry-title">Indian Donors </h1>
                         
                            <div style="margin-top:20px;" class="entry-content">
                                <h2 style="padding-left: 30px;">Bank Transfer Details</h2>
                                <p style="padding-left: 30px;margin-top:22px;"><strong>Account Name</strong> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;Indian Women and Child Welfare Trust<br>
                                    <strong>Account Number</strong> &nbsp; &nbsp;10634251224<br>
                                    <strong>Bank Name</strong> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;State Bank of India<br>
                                    <strong>Bank A/C Type </strong>&nbsp; &nbsp; &nbsp; &nbsp; Saving Account<br>
                                    <strong>Bank Address</strong> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;G-3, VIKAS PURI, NEW DELHI- 110018, India<br>
                                    <strong>Bank IFSC Code</strong> &nbsp; &nbsp; &nbsp; SBIN0009110<br>
                                    <strong>Bank MICR No.</strong> &nbsp; &nbsp; &nbsp; &nbsp;110002178</p>
                                <h2 style="padding-left: 30px;">&nbsp;</h2>
                                <h2>&nbsp; &nbsp; Click to Online Giving</h2>
                                <p style="padding-left: 30px;margin-top:20px;"><a href="https://pmny.in/kIuMxkTrU7d3" class="btn btn-warning btn-lg"><span></i>Donate Now</i></span></a></p>
